...
//sampler sampler badgeTexSmpSC 2:22
...
//texture texture2D badgeTex 2:3:2:22
...
//texture texture2DArray badgeTexArrSC 2:34:2:22
//texture texture2DArray baseTexArrSC 2:35:2:23
...
uniform bool showBadge;
uniform vec4 baseTexSize;
uniform vec4 baseTexView;
uniform mat3 baseTexTransform;
uniform vec4 baseTexUvMinMax;
uniform vec4 baseTexBorderColor;
uniform vec4 badgeTexSize;
uniform vec4 badgeTexView;
uniform mat3 badgeTexTransform;
uniform vec4 badgeTexUvMinMax;
uniform vec4 badgeTexBorderColor;
uniform float alpha;
uniform vec2 Port_Center_N012;
uniform float Port_Input0_N003;
uniform float Port_Input1_N003;
uniform vec2 Port_Input1_N002;
uniform vec2 Port_Scale_N018;
...
#endif
#ifndef badgeTexHasSwappedViews
#define badgeTexHasSwappedViews 0
#elif badgeTexHasSwappedViews==1
#undef badgeTexHasSwappedViews
#define badgeTexHasSwappedViews 1
#endif
#ifndef badgeTexLayout
#define badgeTexLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_badgeTex
#define SC_USE_UV_TRANSFORM_badgeTex 0
#elif SC_USE_UV_TRANSFORM_badgeTex==1
#undef SC_USE_UV_TRANSFORM_badgeTex
#define SC_USE_UV_TRANSFORM_badgeTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_badgeTex
#define SC_SOFTWARE_WRAP_MODE_U_badgeTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_badgeTex
#define SC_SOFTWARE_WRAP_MODE_V_badgeTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_badgeTex
#define SC_USE_UV_MIN_MAX_badgeTex 0
#elif SC_USE_UV_MIN_MAX_badgeTex==1
#undef SC_USE_UV_MIN_MAX_badgeTex
#define SC_USE_UV_MIN_MAX_badgeTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_badgeTex
#define SC_USE_CLAMP_TO_BORDER_badgeTex 0
#elif SC_USE_CLAMP_TO_BORDER_badgeTex==1
#undef SC_USE_CLAMP_TO_BORDER_badgeTex
#define SC_USE_CLAMP_TO_BORDER_badgeTex 1
#endif
#ifndef sc_DepthOnly
...
uniform sampler2D badgeTex;
uniform sampler2DArray badgeTexArrSC;
...
int badgeTexGetStereoViewIndex()
{
int l9_0;
#if (badgeTexHasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
vec4 l9_2;
if ((float(showBadge)*1.0)!=0.0)
{
vec2 l9_3=l9_0-Port_Center_N012;
vec2 l9_4=(l9_3*(vec2(min(baseTexSize.x,baseTexSize.y))/baseTexSize.xy))+Port_Center_N012;
vec4 l9_5;
#if (baseTexLayout==2)
{
l9_5=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_5=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
float l9_6=distance(l9_0,Port_Input1_N002);
vec2 l9_7=l9_0-Port_Center_N018;
vec2 l9_8=(l9_7*Port_Scale_N018)+Port_Center_N018;
vec4 l9_9;
#if (badgeTexLayout==2)
{
l9_9=sc_SampleTextureBiasOrLevel(badgeTexDims.xy,badgeTexLayout,badgeTexGetStereoViewIndex(),l9_8,(int(SC_USE_UV_TRANSFORM_badgeTex)!=0),badgeTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_badgeTex,SC_SOFTWARE_WRAP_MODE_V_badgeTex),(int(SC_USE_UV_MIN_MAX_badgeTex)!=0),badgeTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_badgeTex)!=0),badgeTexBorderColor,0.0,badgeTexArrSC);
}
#else
{
l9_9=sc_SampleTextureBiasOrLevel(badgeTexDims.xy,badgeTexLayout,badgeTexGetStereoViewIndex(),l9_8,(int(SC_USE_UV_TRANSFORM_badgeTex)!=0),badgeTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_badgeTex,SC_SOFTWARE_WRAP_MODE_V_badgeTex),(int(SC_USE_UV_MIN_MAX_badgeTex)!=0),badgeTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_badgeTex)!=0),badgeTexBorderColor,0.0,badgeTex);
}
#endif
l9_2=vec4((l9_5.xyz*(1.0-l9_9.w))+(l9_9.xyz*l9_9.w),clamp(l9_9.w+(l9_5.w*smoothstep(Port_Input0_N003,Port_Input1_N003,l9_6)),0.0,1.0));
}
else
{
vec2 l9_10=l9_0-Port_Center_N012;
vec2 l9_11=(l9_10*(vec2(min(baseTexSize.x,baseTexSize.y))/baseTexSize.xy))+Port_Center_N012;
vec4 l9_12;
#if (baseTexLayout==2)
{
l9_12=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_11,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_12=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_11,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
l9_13.w=l9_12.w*smoothstep(Port_Input0_N003,Port_Input1_N003,distance(l9_0,Port_Input1_N002));
l9_2=l9_13;
}
float l9_14=l9_2.w*alpha;
vec4 l9_15=vec4(l9_2.x,l9_2.y,l9_2.z,vec4(0.0).w);
l9_15.w=l9_14;
...
#endif
sc_writeFragData0(max(l9_16,vec4(0.0)));
return;
}
vec4 l9_18;
...
{
l9_21=clamp(dot(l9_15.xyz,vec3(l9_14)),0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_23=(1.0-dot(l9_15.xyz,vec3(0.33333001)))*l9_14;
}
#else
{
float l9_24;
...
{
l9_24=(1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0))*l9_14;
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_26;
#if (sc_BlendMode_Add)
{
l9_26=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_27=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*l9_14;
}
#else
{
float l9_28;
...
{
l9_28=dot(l9_15.xyz,vec3(0.33333001))*l9_14;
}
#else
{
float l9_29;
#if (sc_BlendMode_Min)
{
l9_29=1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_Max)
{
l9_30=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_30=1.0;
...
#endif
l9_18=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_15.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_19);
}
#else
{
vec4 l9_31;
...
{
l9_39=sc_SampleView(sc_ScreenTextureDims.xy,l9_37,sc_ScreenTextureLayout,l9_38,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_39=sc_SampleView(sc_ScreenTextureDims.xy,l9_37,sc_ScreenTextureLayout,l9_38,0.0,sc_ScreenTexture);
}
#endif
l9_33=l9_39;
}
...
{
vec4 l9_41=l9_33;
l9_41.x=l9_33.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_40=l9_41;
}
#else
{
...
#endif
vec3 l9_42=mix(l9_40.xyz,definedBlend(l9_40.xyz,l9_15.xyz).xyz,vec3(l9_14));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_44=vec4(mix(vec3(1.0),l9_15.xyz,vec3(l9_14)),l9_14);
}
#else
{
vec4 l9_45;
...
#endif
l9_45=vec4(l9_15.xyz*l9_46,l9_46);
}
#else
{
l9_45=l9_15;
...
#endif
int l9_55=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_54).xy);
...
if (l9_72==0)
{
l9_75=texture(sc_OITAlpha0,l9_67);
l9_74=texture(sc_OITDepthLow0,l9_67);
l9_73=texture(sc_OITDepthHigh0,l9_67);
}
else
{
l9_75=vec4(0.0);
...
if (l9_72==1)
{
l9_78=texture(sc_OITAlpha1,l9_67);
l9_77=texture(sc_OITDepthLow1,l9_67);
l9_76=texture(sc_OITDepthHigh1,l9_67);
}
else
{
l9_78=l9_75;
...
vec4 l9_93=texture(sc_OITFilteredDepthBoundsTexture,l9_67);
vec2 l9_94=l9_93.xy;
int l9_95;
#if (sc_SkinBonesCount>0)
{
