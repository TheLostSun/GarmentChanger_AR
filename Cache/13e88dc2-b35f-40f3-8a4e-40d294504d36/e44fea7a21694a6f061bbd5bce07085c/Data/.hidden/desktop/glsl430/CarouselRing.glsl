...
//sampler sampler ringTexSmpSC 2:22
...
//texture texture2D ringTex 2:4:2:22
...
//texture texture2DArray ringTexArrSC 2:33:2:22
...
uniform vec4 ringTexSize;
uniform vec4 ringTexView;
uniform mat3 ringTexTransform;
uniform vec4 ringTexUvMinMax;
uniform vec4 ringTexBorderColor;
uniform float alpha;
...
#endif
#ifndef ringTexHasSwappedViews
#define ringTexHasSwappedViews 0
#elif ringTexHasSwappedViews==1
#undef ringTexHasSwappedViews
#define ringTexHasSwappedViews 1
#endif
#ifndef ringTexLayout
#define ringTexLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_ringTex
#define SC_USE_UV_TRANSFORM_ringTex 0
#elif SC_USE_UV_TRANSFORM_ringTex==1
#undef SC_USE_UV_TRANSFORM_ringTex
#define SC_USE_UV_TRANSFORM_ringTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_ringTex
#define SC_SOFTWARE_WRAP_MODE_U_ringTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_ringTex
#define SC_SOFTWARE_WRAP_MODE_V_ringTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_ringTex
#define SC_USE_UV_MIN_MAX_ringTex 0
#elif SC_USE_UV_MIN_MAX_ringTex==1
#undef SC_USE_UV_MIN_MAX_ringTex
#define SC_USE_UV_MIN_MAX_ringTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_ringTex
#define SC_USE_CLAMP_TO_BORDER_ringTex 0
#elif SC_USE_CLAMP_TO_BORDER_ringTex==1
#undef SC_USE_CLAMP_TO_BORDER_ringTex
#define SC_USE_CLAMP_TO_BORDER_ringTex 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2DArray ringTexArrSC;
...
int ringTexGetStereoViewIndex()
{
int l9_0;
#if (ringTexHasSwappedViews)
{
...
#if (ringTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(ringTexDims.xy,ringTexLayout,ringTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_ringTex)!=0),ringTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_ringTex,SC_SOFTWARE_WRAP_MODE_V_ringTex),(int(SC_USE_UV_MIN_MAX_ringTex)!=0),ringTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_ringTex)!=0),ringTexBorderColor,0.0,ringTexArrSC);
}
#else
{
l9_2=sc_SampleTextureBiasOrLevel(ringTexDims.xy,ringTexLayout,ringTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_ringTex)!=0),ringTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_ringTex,SC_SOFTWARE_WRAP_MODE_V_ringTex),(int(SC_USE_UV_MIN_MAX_ringTex)!=0),ringTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_ringTex)!=0),ringTexBorderColor,0.0,ringTex);
}
#endif
float l9_3=l9_2.w*alpha;
...
{
l9_10=clamp(dot(l9_4.xyz,vec3(l9_3)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_3;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_3;
}
#else
{
float l9_14;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_3;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_4.xyz,vec3(0.33333001))*l9_3;
}
#else
{
float l9_18;
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_4.xyz).xyz,vec3(l9_3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_3)),l9_3);
}
#else
{
vec4 l9_34;
