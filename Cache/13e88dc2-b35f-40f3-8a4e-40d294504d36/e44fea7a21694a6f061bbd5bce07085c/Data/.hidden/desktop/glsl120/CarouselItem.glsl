...
//sampler sampler badgeTexSmpSC 2:17
...
//texture texture2D badgeTex 2:0:2:17
...
{
vec4 l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),((varPackedTex.xy-Port_Center_N012)*(vec2(min(baseTexSize.x,baseTexSize.y))/baseTexSize.xy))+Port_Center_N012,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
int l9_2;
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(badgeTexDims.xy,badgeTexLayout,l9_2,((varPackedTex.xy-Port_Center_N018)*Port_Scale_N018)+Port_Center_N018,(int(SC_USE_UV_TRANSFORM_badgeTex)!=0),badgeTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_badgeTex,SC_SOFTWARE_WRAP_MODE_V_badgeTex),(int(SC_USE_UV_MIN_MAX_badgeTex)!=0),badgeTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_badgeTex)!=0),badgeTexBorderColor,0.0,badgeTex);
float l9_4=l9_3.w;
l9_0=vec4((l9_1.xyz*(1.0-l9_4))+(l9_3.xyz*l9_4),clamp(l9_4+(l9_1.w*smoothstep(Port_Input0_N003,Port_Input1_N003,distance(varPackedTex.xy,Port_Input1_N002))),0.0,1.0));
}
else
{
vec4 l9_5=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),((varPackedTex.xy-Port_Center_N012)*(vec2(min(baseTexSize.x,baseTexSize.y))/baseTexSize.xy))+Port_Center_N012,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_6=vec4(l9_5.x,l9_5.y,l9_5.z,vec4(0.0).w);
l9_6.w=l9_5.w*smoothstep(Port_Input0_N003,Port_Input1_N003,distance(varPackedTex.xy,Port_Input1_N002));
l9_0=l9_6;
}
float l9_7=l9_0.w*alpha;
vec4 l9_8=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_8.w=l9_7;
...
{
l9_12=clamp(dot(l9_8.xyz,vec3(l9_7)),0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_14=(1.0-dot(l9_8.xyz,vec3(0.33333001)))*l9_7;
}
#else
{
float l9_15;
...
{
l9_15=(1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0))*l9_7;
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_17;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_18=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_19;
...
{
l9_19=dot(l9_8.xyz,vec3(0.33333001))*l9_7;
}
#else
{
float l9_20;
...
#else
{
vec2 l9_28=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_29;
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_8.xyz).xyz,vec3(l9_7));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_35;
