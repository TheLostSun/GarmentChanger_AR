...
//sampler sampler z_hitIdAndBarycentricSmp 2:40
//sampler sampler z_rayDirectionsSmpSC 2:41
//texture texture2D baseTex 2:3:2:26
//texture texture2D intensityTexture 2:4:2:27
//texture texture2D normalTex 2:5:2:28
//texture texture2D sc_EnvmapDiffuse 2:6:2:29
//texture texture2D sc_EnvmapSpecular 2:7:2:30
...
//texture texture2D sc_RayTracedAoTexture 2:16:2:32
//texture texture2D sc_RayTracedDiffIndTexture 2:17:2:33
//texture texture2D sc_RayTracedReflectionTexture 2:18:2:34
//texture texture2D sc_RayTracedShadowTexture 2:19:2:35
//texture texture2D sc_SSAOTexture 2:20:2:36
//texture texture2D sc_ScreenTexture 2:21:2:37
//texture texture2D sc_ShadowTexture 2:22:2:38
//texture utexture2D z_hitIdAndBarycentric 2:24:2:40
//texture texture2D z_rayDirections 2:25:2:41
//texture texture2DArray baseTexArrSC 2:42:2:26
//texture texture2DArray intensityTextureArrSC 2:43:2:27
//texture texture2DArray normalTexArrSC 2:44:2:28
//texture texture2DArray sc_EnvmapDiffuseArrSC 2:45:2:29
//texture texture2DArray sc_EnvmapSpecularArrSC 2:46:2:30
//texture texture2DArray sc_RayTracedAoTextureArrSC 2:47:2:32
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 2:48:2:33
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 2:49:2:34
//texture texture2DArray sc_RayTracedShadowTextureArrSC 2:50:2:35
//texture texture2DArray sc_ScreenTextureArrSC 2:51:2:37
...
#endif
float l9_0=radians(uvAngle);
float l9_1=sin(l9_0);
float l9_2=cos(l9_0);
vec2 l9_3=(((varPackedTex.xy-Port_Center_N016)*vec2(uvScale))+Port_Center_N016)-Port_Center_N005;
vec2 l9_4=vec2(dot(vec2(l9_2,l9_1),l9_3),dot(vec2(-l9_1,l9_2),l9_3))+Port_Center_N005;
#if (baseTexLayout==2)
{
}
#else
...
{
l9_6=((l9_5.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_6=vec3(0.0);
...
uint l9_17;
if (Port_Roughness_N006<0.0)
{
l9_17=1023u;
}
else
{
l9_17=uint(clamp(Port_Roughness_N006,0.0,1.0)*1000.0);
}
...
l9_4=varPos;
l9_3=l9_11;
l9_2=cross(l9_10,l9_11)*varTangent.w;
l9_1=l9_10;
l9_0=varPackedTex.xy;
}
vec2 l9_12=l9_0-Port_Center_N016;
float l9_13=radians(uvAngle);
float l9_14=sin(l9_13);
float l9_15=cos(l9_13);
vec2 l9_16=((l9_12*vec2(uvScale))+Port_Center_N016)-Port_Center_N005;
vec2 l9_17=vec2(dot(vec2(l9_15,l9_14),l9_16),dot(vec2(-l9_14,l9_15),l9_16))+Port_Center_N005;
vec4 l9_18;
#if (baseTexLayout==2)
{
l9_18=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_18=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec4 l9_19=baseColor*l9_18;
vec4 l9_20=l9_18*l9_18;
vec4 l9_21=l9_20*l9_18;
vec4 l9_22=l9_21*l9_18;
vec4 l9_23=l9_22*l9_18;
vec4 l9_24=clamp((l9_23*vec4(Port_Input5_N027))+vec4(0.001),Port_Input1_N028+vec4(0.001),Port_Input2_N028+vec4(0.001))-vec4(0.001);
vec3 l9_25=l9_19.xyz;
vec3 l9_26=min(l9_25/(vec3(1.0)-l9_24.xyz),vec3(1.0));
float l9_27=l9_24.x;
float l9_28;
if (l9_27==1.0)
{
...
vec3 l9_33=vec3(l9_28,l9_30,l9_32);
vec4 l9_34=clamp((vec4(l9_1.y)*Port_Value_N024)+vec4(0.001),Port_Input1_N025+vec4(0.001),Port_Input2_N025+vec4(0.001))-vec4(0.001);
vec3 l9_35=mix(l9_25,l9_33.xyz,vec3(l9_24.w)).xyz;
vec3 l9_36=min(l9_35/(vec3(1.0)-l9_34.xyz),vec3(1.0));
float l9_37=l9_34.x;
float l9_38;
if (l9_37==1.0)
{
...
vec3 l9_43=vec3(l9_38,l9_40,l9_42);
vec4 l9_44;
#if (normalTexLayout==2)
{
l9_44=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_44=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#endif
mat3 l9_45=mat3(l9_3,l9_2,l9_1);
vec3 l9_46=-l9_5;
vec4 l9_47=baseColor*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_48;
#if (!sc_ProjectiveShadowsCaster)
{
l9_48=((l9_44.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_48=vec3(0.0);
...
#endif
vec3 l9_49=max(mix(l9_35,l9_43.xyz,vec3(l9_34.w)).xyz,vec3(0.0));
vec4 l9_50;
#if (sc_ProjectiveShadowsCaster)
{
l9_50=vec4(l9_49,Port_Opacity_N006);
}
#else
{
l9_50=ngsCalculateLighting(l9_49,Port_Opacity_N006,l9_48,l9_4,l9_5,max((clamp((vec4(max(pow(1.0-abs(dot(l9_46,l9_45*Port_Normal_N010)),Port_Exponent_N010),0.0)*Port_Intensity_N010)*(mix(Port_Input0_N102,mix(vec4(dot(l9_47,Port_Input1_N094)),l9_47,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))+Port_Input1_N014))+vec4(0.001),Port_Input1_N017+vec4(0.001),Port_Input2_N017+vec4(0.001))-vec4(0.001)).xyz,vec3(0.0)),Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_51=max(l9_50,vec4(0.0));
if (isProxyMode)
{
vec4 l9_52;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_52,vec4(0.0)));
return;
}
vec4 l9_54;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_56=clamp(l9_51.w*2.0,0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_57=clamp(dot(l9_51.xyz,vec3(l9_51.w)),0.0,1.0);
}
#else
{
float l9_58;
...
#if (sc_BlendMode_Multiply)
{
l9_59=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*l9_51.w;
}
#else
{
float l9_60;
...
{
l9_60=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*l9_51.w;
}
#else
{
float l9_61;
#if (sc_BlendMode_ColoredGlass)
{
l9_61=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_51.w;
}
#else
{
float l9_62;
#if (sc_BlendMode_Add)
{
l9_62=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_63;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_63=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_51.w;
}
#else
{
float l9_64;
...
{
l9_64=dot(l9_51.xyz,vec3(0.33333001))*l9_51.w;
}
#else
{
float l9_65;
#if (sc_BlendMode_Min)
{
l9_65=1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_66;
#if (sc_BlendMode_Max)
{
l9_66=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_66=1.0;
...
#endif
l9_54=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_51.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_55);
}
#else
{
vec4 l9_67;
...
{
vec3 l9_69=sc_GetFramebufferColor().xyz;
vec3 l9_70=mix(l9_69,definedBlend(l9_69,l9_51.xyz).xyz,vec3(l9_51.w));
...
{
float l9_73=l9_51.w;
l9_72=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_73)),l9_73);
}
#else
{
vec4 l9_74;
...
#endif
l9_74=vec4(l9_51.xyz*l9_76,l9_76);
}
#else
{
l9_74=l9_51;
