...
//sampler sampler normalTexSmpSC 2:19
...
//sampler sampler sc_SSAOTextureSmpSC 2:23
//sampler sampler sc_ScreenTextureSmpSC 2:24
//sampler sampler sc_ShadowTextureSmpSC 2:25
//texture texture2D baseTex 2:0:2:17
//texture texture2D intensityTexture 2:1:2:18
//texture texture2D normalTex 2:2:2:19
//texture texture2D sc_EnvmapDiffuse 2:3:2:20
//texture texture2D sc_EnvmapSpecular 2:4:2:21
...
//texture texture2D sc_SSAOTexture 2:13:2:23
//texture texture2D sc_ScreenTexture 2:14:2:24
//texture texture2D sc_ShadowTexture 2:15:2:25
//SG_REFLECTION_END
...
uniform float Port_Input5_N027;
uniform vec4 Port_Input1_N028;
uniform vec4 Port_Input2_N028;
uniform vec4 Port_Value_N024;
uniform vec4 Port_Input1_N025;
uniform vec4 Port_Input2_N025;
uniform float Port_Opacity_N006;
uniform vec3 Port_Normal_N010;
uniform float Port_Exponent_N010;
uniform float Port_Intensity_N010;
...
vec3 l9_2=normalize(sc_Camera.position-varPos);
float l9_3=radians(uvAngle);
float l9_4=sin(l9_3);
float l9_5=cos(l9_3);
vec2 l9_6=(((varPackedTex.xy-Port_Center_N016)*vec2(uvScale))+Port_Center_N016)-Port_Center_N005;
vec2 l9_7=vec2(dot(vec2(l9_5,l9_4),l9_6),dot(vec2(-l9_4,l9_5),l9_6))+Port_Center_N005;
int l9_8;
...
#endif
vec4 l9_9=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_8,l9_7,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_10=clamp((((((l9_9*l9_9)*l9_9)*l9_9)*l9_9)*vec4(Port_Input5_N027))+vec4(0.001),Port_Input1_N028+vec4(0.001),Port_Input2_N028+vec4(0.001))-vec4(0.001);
vec3 l9_11=(baseColor*l9_9).xyz;
vec3 l9_12=min(l9_11/(vec3(1.0)-l9_10.xyz),vec3(1.0));
float l9_13=l9_10.x;
float l9_14;
if (l9_13==1.0)
{
...
vec3 l9_19=vec3(l9_14,l9_16,l9_18);
vec4 l9_20=clamp((vec4(l9_0.y)*Port_Value_N024)+vec4(0.001),Port_Input1_N025+vec4(0.001),Port_Input2_N025+vec4(0.001))-vec4(0.001);
vec3 l9_21=mix(l9_11,l9_19.xyz,vec3(l9_10.w)).xyz;
vec3 l9_22=min(l9_21/(vec3(1.0)-l9_20.xyz),vec3(1.0));
float l9_23=l9_20.x;
float l9_24;
if (l9_23==1.0)
{
...
vec3 l9_29=vec3(l9_24,l9_26,l9_28);
int l9_30;
...
#endif
vec4 l9_31=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,l9_30,l9_7,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
vec3 l9_32=-l9_2;
vec4 l9_33=baseColor*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_34;
#if (!sc_ProjectiveShadowsCaster)
{
l9_34=((l9_31.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_34=vec3(0.0);
...
#endif
vec3 l9_35=max(mix(l9_21,l9_29.xyz,vec3(l9_20.w)).xyz,vec3(0.0));
vec4 l9_36;
#if (sc_ProjectiveShadowsCaster)
{
l9_36=vec4(l9_35,Port_Opacity_N006);
}
#else
{
vec3 l9_37=ssSRGB_to_Linear(l9_35);
vec3 l9_38=normalize(l9_34);
vec3 l9_39=ssSRGB_to_Linear(max((clamp((vec4(max(pow(1.0-abs(dot(l9_32,mat3(l9_1,cross(l9_0,l9_1)*varTangent.w,l9_0)*Port_Normal_N010)),Port_Exponent_N010),0.0)*Port_Intensity_N010)*(mix(Port_Input0_N102,mix(vec4(dot(l9_33,Port_Input1_N094)),l9_33,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))+Port_Input1_N014))+vec4(0.001),Port_Input1_N017+vec4(0.001),Port_Input2_N017+vec4(0.001))-vec4(0.001)).xyz,vec3(0.0)));
vec3 l9_40;
#if (sc_SSAOEnabled)
{
l9_40=evaluateSSAO(varPos);
}
#else
{
l9_40=Port_AO_N006;
...
#endif
vec3 l9_41=vec3(Port_Metallic_N006);
vec3 l9_42=mix(vec3(0.039999999),l9_37*Port_Metallic_N006,l9_41);
vec3 l9_43=mix(l9_37*(1.0-Port_Metallic_N006),vec3(0.0),l9_41);
SurfaceProperties l9_44=SurfaceProperties(l9_43,Port_Opacity_N006,l9_38,varPos,l9_2,Port_Metallic_N006,Port_Roughness_N006,l9_39,l9_40,Port_SpecularAO_N006,vec3(1.0),l9_42);
vec4 l9_45=vec4(1.0);
vec3 l9_46;
vec3 l9_47;
vec3 l9_48;
...
{
LightingComponents l9_65=accumulateLight(LightingComponents(l9_53,l9_54,l9_59,l9_58,l9_56,l9_55),LightProperties(sc_DirectionalLights[l9_64].direction,sc_DirectionalLights[l9_64].color.xyz,sc_DirectionalLights[l9_64].color.w*l9_45[(l9_57<3) ? l9_57 : 3]),l9_44,l9_2);
...
{
vec3 l9_84=sc_PointLights[l9_82].position-varPos;
...
l9_75=l9_83+1;
LightingComponents l9_90=accumulateLight(LightingComponents(l9_69,l9_70,l9_74,l9_73,l9_72,l9_71),LightProperties(l9_85,sc_PointLights[l9_82].color.xyz,l9_89),l9_44,l9_2);
...
#endif
l9_100=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_101,sc_EnvmapDiffuseLayout,l9_102,-13.0,sc_EnvmapDiffuse);
}
#else
{
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_132=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_133=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_38,reflect(l9_32,l9_38),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_134;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_131=vec3(0.0)+((((l9_134.xyz*(1.0/l9_134.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_44,abs(dot(l9_38,l9_2))));
}
#else
{
l9_131=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_138=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_139;
...
vec3 l9_142=reflect(l9_32,l9_38);
float l9_143=dot(l9_38,l9_2);
...
l9_152=vec3(0.0);
l9_151=vec3(0.0);
l9_150=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_43,vec3(Port_Opacity_N006));
l9_149=1.0;
}
#else
{
...
vec3 l9_157=l9_137*Port_SpecularAO_N006;
...
{
vec4 l9_165=l9_163;
l9_165.x=l9_162+((l9_40.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_164=l9_165;
}
#else
{
...
l9_36=vec4(l9_169.x,l9_169.y,l9_169.z,l9_166.w);
}
#endif
vec4 l9_170=max(l9_36,vec4(0.0));
vec4 l9_171;
#if (sc_ProjectiveShadowsCaster)
{
float l9_172;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_173=clamp(l9_170.w*2.0,0.0,1.0);
}
#else
{
float l9_174;
...
{
l9_174=clamp(dot(l9_170.xyz,vec3(l9_170.w)),0.0,1.0);
}
#else
{
float l9_175;
...
#if (sc_BlendMode_Multiply)
{
l9_176=(1.0-dot(l9_170.xyz,vec3(0.33333001)))*l9_170.w;
}
#else
{
float l9_177;
...
{
l9_177=(1.0-clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0))*l9_170.w;
}
#else
{
float l9_178;
#if (sc_BlendMode_ColoredGlass)
{
l9_178=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0)*l9_170.w;
}
#else
{
float l9_179;
#if (sc_BlendMode_Add)
{
l9_179=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_180;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_180=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0)*l9_170.w;
}
#else
{
float l9_181;
...
{
l9_181=dot(l9_170.xyz,vec3(0.33333001))*l9_170.w;
}
#else
{
float l9_182;
#if (sc_BlendMode_Min)
{
l9_182=1.0-clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_183;
#if (sc_BlendMode_Max)
{
l9_183=clamp(dot(l9_170.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_183=1.0;
...
#endif
l9_171=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_170.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_172);
}
#else
{
vec4 l9_184;
...
{
vec3 l9_186=sc_GetFramebufferColor().xyz;
vec3 l9_187=mix(l9_186,definedBlend(l9_186,l9_170.xyz).xyz,vec3(l9_170.w));
vec4 l9_188=vec4(l9_187.x,l9_187.y,l9_187.z,vec4(0.0).w);
l9_188.w=1.0;
l9_185=l9_188;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_190=l9_170.w;
l9_189=vec4(mix(vec3(1.0),l9_170.xyz,vec3(l9_190)),l9_190);
}
#else
{
vec4 l9_191;
...
{
float l9_192=l9_170.w;
float l9_193;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_193=clamp(l9_192,0.0,1.0);
}
#else
{
l9_193=l9_192;
...
#endif
l9_191=vec4(l9_170.xyz*l9_193,l9_193);
}
#else
{
l9_191=l9_170;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_201=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_214=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
