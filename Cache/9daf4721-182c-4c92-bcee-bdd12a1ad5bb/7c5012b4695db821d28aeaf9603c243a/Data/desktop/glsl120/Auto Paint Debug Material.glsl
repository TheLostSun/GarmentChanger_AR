...
attribute vec2 externalMeshVisData;
varying vec2 Interpolator_N76_vec2_externalMeshVisData;
...
vec4 l9_2=vec4(l9_1*step(1.0-Interpolator_N76_vec2_externalMeshVisData.y,distanceThreshold),Port_Value2_N042,Port_Value3_N042,Port_Value4_N042);
...
{
l9_5=clamp(Port_Value4_N042*2.0,0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_6=clamp(dot(l9_2.xyz,vec3(Port_Value4_N042)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*Port_Value4_N042;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*Port_Value4_N042;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N042;
}
#else
{
float l9_11;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N042;
}
#else
{
float l9_13;
...
{
l9_13=dot(l9_2.xyz,vec3(0.33333001))*Port_Value4_N042;
}
#else
{
float l9_14;
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_2.xyz).xyz,vec3(Port_Value4_N042));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_2.xyz,vec3(Port_Value4_N042)),Port_Value4_N042);
}
#else
{
vec4 l9_29;
...
{
l9_30=clamp(Port_Value4_N042,0.0,1.0);
}
#else
{
l9_30=Port_Value4_N042;
}
#endif
