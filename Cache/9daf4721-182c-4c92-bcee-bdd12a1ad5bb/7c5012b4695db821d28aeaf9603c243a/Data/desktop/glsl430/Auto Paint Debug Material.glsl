...
//attribute vec2 externalMeshVisData 19
...
uniform float Port_Value2_N042;
uniform float Port_Value3_N042;
uniform float Port_Value4_N042;
...
in vec2 externalMeshVisData;
out vec2 Interpolator_N76_vec2_externalMeshVisData;
...
Interpolator_N76_vec2_externalMeshVisData=externalMeshVisData;
}
...
in vec2 Interpolator_N76_vec2_externalMeshVisData;
in vec3 varPos;
in vec3 varNormal;
in vec4 varTangent;
...
l9_0=Interpolator_N76_vec2_externalMeshVisData;
}
else
{
l9_0=Interpolator_N76_vec2_externalMeshVisData;
...
vec4 l9_4=vec4(l9_3*step(1.0-l9_0.y,distanceThreshold),Port_Value2_N042,Port_Value3_N042,Port_Value4_N042);
#if (sc_BlendMode_AlphaTest)
{
if (Port_Value4_N042<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Value4_N042<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_9=clamp(Port_Value4_N042*2.0,0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_4.xyz,vec3(Port_Value4_N042)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*Port_Value4_N042;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*Port_Value4_N042;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N042;
}
#else
{
float l9_15;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N042;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_4.xyz,vec3(0.33333001))*Port_Value4_N042;
}
#else
{
float l9_18;
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_4.xyz).xyz,vec3(Port_Value4_N042));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_4.xyz,vec3(Port_Value4_N042)),Port_Value4_N042);
}
#else
{
vec4 l9_34;
...
{
l9_35=clamp(Port_Value4_N042,0.0,1.0);
}
#else
{
l9_35=Port_Value4_N042;
}
#endif
