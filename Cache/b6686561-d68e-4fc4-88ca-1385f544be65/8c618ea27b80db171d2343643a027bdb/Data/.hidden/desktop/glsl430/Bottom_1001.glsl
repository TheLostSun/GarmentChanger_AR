...
//sampler sampler baseTexSmpSC 2:33
//sampler sampler detailNormalTexSmpSC 2:34
//sampler sampler emissiveTexSmpSC 2:35
//sampler sampler intensityTextureSmpSC 2:36
//sampler sampler materialParamsTexSmpSC 2:37
//sampler sampler normalTexSmpSC 2:38
//sampler sampler opacityTexSmpSC 2:39
//sampler sampler reflectionModulationTexSmpSC 2:40
//sampler sampler reflectionTexSmpSC 2:41
//sampler sampler rimColorTexSmpSC 2:42
...
//sampler sampler z_hitIdAndBarycentricSmp 2:54
//sampler sampler z_rayDirectionsSmpSC 2:55
//texture texture2D baseTex 2:3:2:33
//texture texture2D detailNormalTex 2:4:2:34
//texture texture2D emissiveTex 2:5:2:35
//texture texture2D intensityTexture 2:6:2:36
//texture texture2D materialParamsTex 2:7:2:37
//texture texture2D normalTex 2:8:2:38
//texture texture2D opacityTex 2:9:2:39
//texture texture2D reflectionModulationTex 2:10:2:40
//texture texture2D reflectionTex 2:11:2:41
//texture texture2D rimColorTex 2:12:2:42
//texture texture2D sc_EnvmapDiffuse 2:13:2:43
//texture texture2D sc_EnvmapSpecular 2:14:2:44
//texture texture2D sc_OITAlpha0 2:15:2:45
//texture texture2D sc_OITAlpha1 2:16:2:45
//texture texture2D sc_OITDepthHigh0 2:17:2:45
//texture texture2D sc_OITDepthHigh1 2:18:2:45
//texture texture2D sc_OITDepthLow0 2:19:2:45
//texture texture2D sc_OITDepthLow1 2:20:2:45
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:21:2:45
//texture texture2D sc_OITFrontDepthTexture 2:22:2:45
//texture texture2D sc_RayTracedAoTexture 2:23:2:46
//texture texture2D sc_RayTracedDiffIndTexture 2:24:2:47
//texture texture2D sc_RayTracedReflectionTexture 2:25:2:48
//texture texture2D sc_RayTracedShadowTexture 2:26:2:49
//texture texture2D sc_SSAOTexture 2:27:2:50
//texture texture2D sc_ScreenTexture 2:28:2:51
//texture texture2D sc_ShadowTexture 2:29:2:52
//texture utexture2D z_hitIdAndBarycentric 2:31:2:54
//texture texture2D z_rayDirections 2:32:2:55
//texture texture2DArray baseTexArrSC 2:56:2:33
//texture texture2DArray detailNormalTexArrSC 2:57:2:34
//texture texture2DArray emissiveTexArrSC 2:58:2:35
//texture texture2DArray intensityTextureArrSC 2:59:2:36
//texture texture2DArray materialParamsTexArrSC 2:60:2:37
//texture texture2DArray normalTexArrSC 2:61:2:38
//texture texture2DArray opacityTexArrSC 2:62:2:39
//texture texture2DArray reflectionModulationTexArrSC 2:63:2:40
//texture texture2DArray reflectionTexArrSC 2:64:2:41
//texture texture2DArray rimColorTexArrSC 2:65:2:42
//texture texture2DArray sc_EnvmapDiffuseArrSC 2:66:2:43
//texture texture2DArray sc_EnvmapSpecularArrSC 2:67:2:44
//texture texture2DArray sc_RayTracedAoTextureArrSC 2:68:2:46
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 2:69:2:47
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 2:70:2:48
//texture texture2DArray sc_RayTracedShadowTextureArrSC 2:71:2:49
//texture texture2DArray sc_ScreenTextureArrSC 2:72:2:51
...
#if (baseTexLayout==2)
{
l9_11=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_11=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#if (ENABLE_RECOLOR)
{
l9_12=vec4(vec3(0.0).x,vec3(0.0).y,vec3(0.0).z,l9_9.w);
}
#else
{
l9_12=l9_9;
...
{
vec2 l9_14=N7_getUV(NODE_69_DROPLIST_ITEM);
vec4 l9_15;
...
#endif
float l9_16=l9_13*l9_12.w;
float l9_17;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_17=l9_16*tempGlobals.VertexColor.w;
}
#else
{
l9_17=l9_16;
...
#if (ENABLE_NORMALMAP)
{
vec2 l9_19=N7_getUV(NODE_181_DROPLIST_ITEM);
vec4 l9_20;
#if (normalTexLayout==2)
{
l9_20=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_20=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#endif
l9_21=(l9_23.xyz*1.9921875)-vec3(1.0);
}
#else
{
l9_21=vec3(0.0,0.0,1.0);
}
#endif
vec3 l9_24=((l9_20.xyz*1.9921875)-vec3(1.0))+vec3(0.0,0.0,1.0);
vec3 l9_25=l9_21*vec3(-1.0,-1.0,1.0);
l9_18=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,tempGlobals.VertexNormal_WorldSpace)*normalize((l9_24*dot(l9_24,l9_25))-(l9_25*l9_24.z)));
}
#else
{
l9_18=normalize(tempGlobals.VertexNormal_WorldSpace);
}
#endif
vec3 l9_26;
#if (ENABLE_EMISSIVE)
{
vec2 l9_27=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_28;
#if (emissiveTexLayout==2)
{
l9_28=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),l9_27,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTexArrSC);
}
#else
{
l9_28=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),l9_27,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTex);
}
#endif
l9_26=l9_28.xyz;
}
...
{
l9_29=l9_26+tempGlobals.VertexColor.xyz;
}
#else
{
l9_29=l9_26;
...
{
l9_30=ssPow((l9_29*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_30=l9_29;
...
{
vec3 l9_32=tempGlobals.ViewDirWS;
vec3 l9_33=reflect(l9_32,l9_18);
float l9_34=l9_33.x;
float l9_35=l9_33.y;
float l9_36=(-l9_33.z)+1.0;
float l9_37=((l9_34*l9_34)+(l9_35*l9_35))+(l9_36*l9_36);
float l9_38;
if (l9_37<=0.0)
{
l9_38=0.0;
...
float l9_39=2.0*l9_38;
vec2 l9_40=vec2(1.0)-((l9_33.xy/vec2(l9_39))+vec2(0.5));
vec4 l9_41;
#if (reflectionTexLayout==2)
{
l9_41=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,reflectionTexGetStereoViewIndex(),l9_40,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTexArrSC);
}
#else
{
l9_41=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,reflectionTexGetStereoViewIndex(),l9_40,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTex);
}
#endif
vec3 l9_42;
#if (Tweak_N177)
{
vec2 l9_43=N7_getUV(NODE_228_DROPLIST_ITEM);
vec4 l9_44;
#if (reflectionModulationTexLayout==2)
{
l9_44=sc_SampleTextureBiasOrLevel(reflectionModulationTexDims.xy,reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex(),l9_43,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex),(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0),reflectionModulationTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0),reflectionModulationTexBorderColor,0.0,reflectionModulationTexArrSC);
}
#else
{
l9_44=sc_SampleTextureBiasOrLevel(reflectionModulationTexDims.xy,reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex(),l9_43,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex),(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0),reflectionModulationTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0),reflectionModulationTexBorderColor,0.0,reflectionModulationTex);
}
#endif
l9_42=l9_41.xyz*l9_44.xyz;
}
#else
{
l9_42=l9_41.xyz;
...
#endif
l9_31=N7_vec3srgbToLinear(l9_42)*reflectionIntensity;
}
#else
{
l9_31=vec3(0.0);
...
{
vec3 l9_46=rimColor*rimIntensity;
vec3 l9_47;
#if (Tweak_N216)
{
vec2 l9_48=N7_getUV(NODE_315_DROPLIST_ITEM);
vec4 l9_49;
#if (rimColorTexLayout==2)
{
l9_49=sc_SampleTextureBiasOrLevel(rimColorTexDims.xy,rimColorTexLayout,rimColorTexGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex),(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0),rimColorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0),rimColorTexBorderColor,0.0,rimColorTexArrSC);
}
#else
{
l9_49=sc_SampleTextureBiasOrLevel(rimColorTexDims.xy,rimColorTexLayout,rimColorTexGetStereoViewIndex(),l9_48,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex),(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0),rimColorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0),rimColorTexBorderColor,0.0,rimColorTex);
}
#endif
l9_47=l9_46*l9_49.xyz;
}
#else
{
l9_47=l9_46;
...
#endif
vec3 l9_50=tempGlobals.ViewDirWS;
float l9_51=dot(l9_18,l9_50);
float l9_52=abs(l9_51);
float l9_53;
...
#endif
l9_45=vec3(0.0)+(N7_vec3srgbToLinear(l9_47)*ssPow(l9_53,rimExponent));
}
#else
{
l9_45=vec3(0.0);
...
#endif
vec2 l9_54=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_55;
#if (materialParamsTexLayout==2)
{
l9_55=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_54,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_55=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_54,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
}
#endif
float l9_56=l9_55.y*roughness;
vec3 l9_57;
...
#endif
float l9_58=clamp(l9_17,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_58<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_58<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
if (dot(l9_8,l9_57)>=(-0.050000001))
{
uvec3 l9_59=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_59.x,l9_59.y,l9_59.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_60=abs(l9_57);
vec3 l9_61=l9_57/vec3(dot(l9_60,vec3(1.0)));
...
uvec2 l9_68=uvec2(packHalf2x16(vec2(l9_65,0.0)),packHalf2x16(vec2(l9_66+l9_67,0.0)));
normal_and_more=uvec4(l9_68.x,l9_68.y,normal_and_more.z,normal_and_more.w);
...
{
l9_69=uint(clamp(l9_56,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_69|uint((receiverId%32)<<int(10u));
}
else
{
...
#if (baseTexLayout==2)
{
l9_22=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_21,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_22=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_21,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#if (ENABLE_RECOLOR)
{
vec3 l9_24=((recolorRed*l9_20.x)+(recolorGreen*l9_20.y))+(recolorBlue*l9_20.z);
l9_23=vec4(l9_24.x,l9_24.y,l9_24.z,l9_20.w);
}
#else
{
l9_23=l9_20;
...
#endif
float l9_28=l9_25*l9_23.w;
vec4 l9_29;
float l9_30;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_30=l9_28*tempGlobals.VertexColor.w;
l9_29=l9_23*tempGlobals.VertexColor;
}
#else
{
l9_30=l9_28;
...
#if (ENABLE_NORMALMAP)
{
vec2 l9_32=N7_getUV(NODE_181_DROPLIST_ITEM);
vec4 l9_33;
#if (normalTexLayout==2)
{
l9_33=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_32,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_33=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_32,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#if (ENABLE_DETAIL_NORMAL)
{
vec2 l9_35=N7_getUV(NODE_184_DROPLIST_ITEM);
vec4 l9_36;
#if (detailNormalTexLayout==2)
{
l9_36=sc_SampleTextureBiasOrLevel(detailNormalTexDims.xy,detailNormalTexLayout,detailNormalTexGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex),(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0),detailNormalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0),detailNormalTexBorderColor,0.0,detailNormalTexArrSC);
}
#else
{
l9_36=sc_SampleTextureBiasOrLevel(detailNormalTexDims.xy,detailNormalTexLayout,detailNormalTexGetStereoViewIndex(),l9_35,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex),(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0),detailNormalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0),detailNormalTexBorderColor,0.0,detailNormalTex);
...
#endif
l9_34=(l9_36.xyz*1.9921875)-vec3(1.0);
}
#else
{
l9_34=vec3(0.0,0.0,1.0);
}
#endif
vec3 l9_37=((l9_33.xyz*1.9921875)-vec3(1.0))+vec3(0.0,0.0,1.0);
vec3 l9_38=l9_34*vec3(-1.0,-1.0,1.0);
l9_31=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,tempGlobals.VertexNormal_WorldSpace)*normalize((l9_37*dot(l9_37,l9_38))-(l9_38*l9_37.z)));
}
#else
{
l9_31=normalize(tempGlobals.VertexNormal_WorldSpace);
}
#endif
vec3 l9_39;
#if (ENABLE_EMISSIVE)
{
vec2 l9_40=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_41;
#if (emissiveTexLayout==2)
{
l9_41=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),l9_40,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTexArrSC);
}
#else
{
l9_41=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),l9_40,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTex);
...
#if (NODE_38_DROPLIST_ITEM==2)
{
l9_42=l9_39+tempGlobals.VertexColor.xyz;
}
#else
{
l9_42=l9_39;
...
#if ((NODE_38_DROPLIST_ITEM==2)||ENABLE_EMISSIVE)
{
l9_43=ssPow((l9_42*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_43=l9_42;
...
#if (ENABLE_SIMPLE_REFLECTION)
{
vec3 l9_45=tempGlobals.ViewDirWS;
vec3 l9_46=reflect(l9_45,l9_31);
float l9_47=l9_46.x;
float l9_48=l9_46.y;
float l9_49=(-l9_46.z)+1.0;
float l9_50=((l9_47*l9_47)+(l9_48*l9_48))+(l9_49*l9_49);
float l9_51;
if (l9_50<=0.0)
{
l9_51=0.0;
...
float l9_52=2.0*l9_51;
vec2 l9_53=vec2(1.0)-((l9_46.xy/vec2(l9_52))+vec2(0.5));
vec4 l9_54;
#if (reflectionTexLayout==2)
{
l9_54=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,reflectionTexGetStereoViewIndex(),l9_53,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTexArrSC);
}
#else
{
l9_54=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,reflectionTexGetStereoViewIndex(),l9_53,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTex);
...
#if (Tweak_N177)
{
vec2 l9_56=N7_getUV(NODE_228_DROPLIST_ITEM);
vec4 l9_57;
#if (reflectionModulationTexLayout==2)
{
l9_57=sc_SampleTextureBiasOrLevel(reflectionModulationTexDims.xy,reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex(),l9_56,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex),(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0),reflectionModulationTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0),reflectionModulationTexBorderColor,0.0,reflectionModulationTexArrSC);
}
#else
{
l9_57=sc_SampleTextureBiasOrLevel(reflectionModulationTexDims.xy,reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex(),l9_56,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex),(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0),reflectionModulationTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0),reflectionModulationTexBorderColor,0.0,reflectionModulationTex);
...
#endif
l9_44=N7_vec3srgbToLinear(l9_55)*reflectionIntensity;
}
#else
{
l9_44=vec3(0.0);
...
#if (ENABLE_RIM_HIGHLIGHT)
{
vec3 l9_59=rimColor*rimIntensity;
vec3 l9_60;
#if (Tweak_N216)
{
vec2 l9_61=N7_getUV(NODE_315_DROPLIST_ITEM);
vec4 l9_62;
#if (rimColorTexLayout==2)
{
l9_62=sc_SampleTextureBiasOrLevel(rimColorTexDims.xy,rimColorTexLayout,rimColorTexGetStereoViewIndex(),l9_61,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex),(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0),rimColorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0),rimColorTexBorderColor,0.0,rimColorTexArrSC);
}
#else
{
l9_62=sc_SampleTextureBiasOrLevel(rimColorTexDims.xy,rimColorTexLayout,rimColorTexGetStereoViewIndex(),l9_61,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex),(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0),rimColorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0),rimColorTexBorderColor,0.0,rimColorTex);
...
#endif
vec3 l9_63=tempGlobals.ViewDirWS;
float l9_64=dot(l9_31,l9_63);
float l9_65=abs(l9_64);
float l9_66;
#if (!ENABLE_RIM_INVERT)
{
l9_66=1.0-l9_65;
...
#endif
l9_58=vec3(0.0)+(N7_vec3srgbToLinear(l9_60)*ssPow(l9_66,rimExponent));
}
#else
{
l9_58=vec3(0.0);
...
#endif
vec3 l9_67=ssPow((l9_43+l9_44)+l9_58,vec3(0.45454547));
vec2 l9_68=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_69;
#if (materialParamsTexLayout==2)
{
l9_69=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_68,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_69=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_68,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
...
#endif
float l9_70=l9_69.x*metallic;
vec3 l9_71;
#if (NODE_38_DROPLIST_ITEM==3)
{
l9_71=vec3(l9_69.z)*tempGlobals.VertexColor.xyz;
}
#else
{
l9_71=vec3(l9_69.z);
...
{
vec3 l9_73=mix(vec3(0.039999999),l9_29.xyz*l9_70,vec3(l9_70));
l9_72=mix(vec3(1.0),mix((l9_73*(1.0-specularAoDarkening))*l9_73,vec3(1.0),vec3(l9_71.x)),vec3(specularAoIntensity));
}
#else
{
l9_72=vec3(1.0);
...
#endif
float l9_76=clamp(l9_30,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_77=max(l9_29.xyz,vec3(0.0));
vec4 l9_78;
#if (sc_ProjectiveShadowsCaster)
{
l9_78=vec4(l9_77,l9_76);
}
#else
{
l9_78=ngsCalculateLighting(l9_77,l9_76,l9_75,l9_10,l9_11,max(l9_67,vec3(0.0)),clamp(l9_70,0.0,1.0),clamp(l9_69.y*roughness,0.0,1.0),clamp(l9_71,vec3(0.0),vec3(1.0)),clamp(l9_74,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_79=max(l9_78,vec4(0.0));
if (isProxyMode)
{
vec4 l9_80;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_80,vec4(0.0)));
return;
}
vec4 l9_82;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_84=clamp(l9_79.w*2.0,0.0,1.0);
}
#else
{
float l9_85;
...
{
l9_85=clamp(dot(l9_79.xyz,vec3(l9_79.w)),0.0,1.0);
}
#else
{
float l9_86;
...
#if (sc_BlendMode_Multiply)
{
l9_87=(1.0-dot(l9_79.xyz,vec3(0.33333001)))*l9_79.w;
}
#else
{
float l9_88;
...
{
l9_88=(1.0-clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0))*l9_79.w;
}
#else
{
float l9_89;
#if (sc_BlendMode_ColoredGlass)
{
l9_89=clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0)*l9_79.w;
}
#else
{
float l9_90;
#if (sc_BlendMode_Add)
{
l9_90=clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_91=clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0)*l9_79.w;
}
#else
{
float l9_92;
...
{
l9_92=dot(l9_79.xyz,vec3(0.33333001))*l9_79.w;
}
#else
{
float l9_93;
#if (sc_BlendMode_Min)
{
l9_93=1.0-clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_94;
#if (sc_BlendMode_Max)
{
l9_94=clamp(dot(l9_79.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_94=1.0;
...
#endif
l9_82=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_79.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_83);
}
#else
{
vec4 l9_95;
...
{
vec3 l9_97=sc_GetFramebufferColor().xyz;
vec3 l9_98=mix(l9_97,definedBlend(l9_97,l9_79.xyz).xyz,vec3(l9_79.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_101=l9_79.w;
l9_100=vec4(mix(vec3(1.0),l9_79.xyz,vec3(l9_101)),l9_101);
}
#else
{
vec4 l9_102;
...
{
float l9_103=l9_79.w;
float l9_104;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_104=clamp(l9_103,0.0,1.0);
}
#else
{
l9_104=l9_103;
...
#endif
l9_102=vec4(l9_79.xyz*l9_104,l9_104);
}
#else
{
l9_102=l9_79;
...
{
l9_107=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_107=vec4(0.0);
...
vec4 l9_109=outputMotionVectorsIfNeeded(varPos,max(l9_108,vec4(0.0)));
vec4 l9_110=clamp(l9_109,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_111=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_111-0.0039215689)),min(1.0,l9_111+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_113=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_112).xy);
float l9_114=packValue(l9_113);
int l9_121=int(l9_110.w*255.0);
float l9_122=packValue(l9_121);
sc_writeFragData0(vec4(packValue(l9_113),packValue(l9_113),packValue(l9_113),packValue(l9_113)));
sc_writeFragData1(vec4(l9_114,packValue(l9_113),packValue(l9_113),packValue(l9_113)));
sc_writeFragData2(vec4(l9_122,packValue(l9_121),packValue(l9_121),packValue(l9_121)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_125=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_125).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_130==0)
{
l9_133=texture(sc_OITAlpha0,l9_125);
l9_132=texture(sc_OITDepthLow0,l9_125);
l9_131=texture(sc_OITDepthHigh0,l9_125);
}
else
{
l9_133=vec4(0.0);
...
if (l9_130==1)
{
l9_136=texture(sc_OITAlpha1,l9_125);
l9_135=texture(sc_OITDepthLow1,l9_125);
l9_134=texture(sc_OITDepthHigh1,l9_125);
}
else
{
l9_136=l9_133;
...
if (any(notEqual(l9_134,vec4(0.0)))||any(notEqual(l9_135,vec4(0.0))))
{
int l9_137[8]=l9_126;
unpackValues(l9_134.w,l9_130,l9_137);
unpackValues(l9_134.z,l9_130,l9_137);
unpackValues(l9_134.y,l9_130,l9_137);
unpackValues(l9_134.x,l9_130,l9_137);
unpackValues(l9_135.w,l9_130,l9_137);
unpackValues(l9_135.z,l9_130,l9_137);
unpackValues(l9_135.y,l9_130,l9_137);
unpackValues(l9_135.x,l9_130,l9_137);
int l9_146[8]=l9_127;
unpackValues(l9_136.w,l9_130,l9_146);
unpackValues(l9_136.z,l9_130,l9_146);
unpackValues(l9_136.y,l9_130,l9_146);
unpackValues(l9_136.x,l9_130,l9_146);
}
l9_130++;
continue;
}
...
vec4 l9_151=texture(sc_OITFilteredDepthBoundsTexture,l9_125);
vec2 l9_152=l9_151.xy;
int l9_153;
#if (sc_SkinBonesCount>0)
{
l9_153=encodeDepth(((1.0-l9_151.x)*1000.0)+getDepthOrderingEpsilon(),l9_152);
}
#else
{
l9_153=0;
...
#endif
int l9_154=encodeDepth(viewSpaceDepth(),l9_152);
vec4 l9_155;
l9_155=l9_110*l9_110.w;
vec4 l9_156;
int l9_157=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_157<8)
{
int l9_158=l9_126[l9_157];
int l9_159=l9_154-l9_153;
bool l9_160=l9_158<l9_159;
bool l9_161;
if (l9_160)
{
l9_161=l9_126[l9_157]>0;
}
else
{
l9_161=l9_160;
...
if (l9_161)
{
vec3 l9_162=l9_155.xyz*(1.0-(float(l9_127[l9_157])/255.0));
l9_156=vec4(l9_162.x,l9_162.y,l9_162.z,l9_155.w);
}
else
{
l9_156=l9_155;
