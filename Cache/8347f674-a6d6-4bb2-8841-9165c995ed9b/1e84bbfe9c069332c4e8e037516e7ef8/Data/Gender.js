...
//@input SceneObject lowerGameObject

script.upperGameObject.enabled=false;
script.lowerGameObject.enabled=false;
function genderSpecifier(isMale) {
    script.upperGameObject.enabled=true;
    script.lowerGameObject.enabled=true;
