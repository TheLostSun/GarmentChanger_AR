...
//sampler sampler cameraImageSmpSC 2:16
...
//texture texture2D cameraImage 2:0:2:16
...
//texture texture2DArray cameraImageArrSC 2:25:2:16
...
uniform vec4 cameraImageSize;
uniform vec4 cameraImageView;
uniform mat3 cameraImageTransform;
uniform vec4 cameraImageUvMinMax;
uniform vec4 cameraImageBorderColor;
...
#endif
#ifndef cameraImageHasSwappedViews
#define cameraImageHasSwappedViews 0
#elif cameraImageHasSwappedViews==1
#undef cameraImageHasSwappedViews
#define cameraImageHasSwappedViews 1
#endif
#ifndef cameraImageLayout
#define cameraImageLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_cameraImage
#define SC_USE_UV_TRANSFORM_cameraImage 0
#elif SC_USE_UV_TRANSFORM_cameraImage==1
#undef SC_USE_UV_TRANSFORM_cameraImage
#define SC_USE_UV_TRANSFORM_cameraImage 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_cameraImage
#define SC_SOFTWARE_WRAP_MODE_U_cameraImage -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_cameraImage
#define SC_SOFTWARE_WRAP_MODE_V_cameraImage -1
#endif
#ifndef SC_USE_UV_MIN_MAX_cameraImage
#define SC_USE_UV_MIN_MAX_cameraImage 0
#elif SC_USE_UV_MIN_MAX_cameraImage==1
#undef SC_USE_UV_MIN_MAX_cameraImage
#define SC_USE_UV_MIN_MAX_cameraImage 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_cameraImage
#define SC_USE_CLAMP_TO_BORDER_cameraImage 0
#elif SC_USE_CLAMP_TO_BORDER_cameraImage==1
#undef SC_USE_CLAMP_TO_BORDER_cameraImage
#define SC_USE_CLAMP_TO_BORDER_cameraImage 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2DArray cameraImageArrSC;
...
int cameraImageGetStereoViewIndex()
{
int l9_0;
#if (cameraImageHasSwappedViews)
{
...
vec4 l9_2;
#if (cameraImageLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(cameraImageDims.xy,cameraImageLayout,cameraImageGetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_cameraImage)!=0),cameraImageTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_cameraImage,SC_SOFTWARE_WRAP_MODE_V_cameraImage),(int(SC_USE_UV_MIN_MAX_cameraImage)!=0),cameraImageUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_cameraImage)!=0),cameraImageBorderColor,0.0,cameraImageArrSC);
}
#else
{
l9_2=sc_SampleTextureBiasOrLevel(cameraImageDims.xy,cameraImageLayout,cameraImageGetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_cameraImage)!=0),cameraImageTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_cameraImage,SC_SOFTWARE_WRAP_MODE_V_cameraImage),(int(SC_USE_UV_MIN_MAX_cameraImage)!=0),cameraImageUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_cameraImage)!=0),cameraImageBorderColor,0.0,cameraImage);
}
#endif
vec4 l9_3=vec4(l9_2.xyz,varColor.w);
#if (sc_BlendMode_AlphaTest)
{
if (varColor.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (varColor.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_6=clamp(varColor.w*2.0,0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(l9_3.xyz,vec3(varColor.w)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*varColor.w;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*varColor.w;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*varColor.w;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*varColor.w;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_3.xyz,vec3(0.33333001))*varColor.w;
}
#else
{
float l9_15;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_3.xyz).xyz,vec3(varColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_3.xyz,vec3(varColor.w)),varColor.w);
}
#else
{
vec4 l9_31;
...
{
l9_32=clamp(varColor.w,0.0,1.0);
}
#else
{
l9_32=varColor.w;
