...
{
l9_7=clamp(varColor.w*2.0,0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_8=clamp(dot(l9_4.xyz,vec3(varColor.w)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*varColor.w;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*varColor.w;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*varColor.w;
}
#else
{
float l9_13;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*varColor.w;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_4.xyz,vec3(0.33333001))*varColor.w;
}
#else
{
float l9_16;
...
#else
{
vec2 l9_24=sc_ScreenCoordsGlobalToView(l9_0);
int l9_25;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_4.xyz).xyz,vec3(varColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_4.xyz,vec3(varColor.w)),varColor.w);
}
#else
{
vec4 l9_31;
