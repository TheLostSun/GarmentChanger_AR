...
//sampler sampler baseTextureSmpSC 2:25
...
//texture texture2D baseTexture 2:3:2:25
...
//texture texture2DArray baseTextureArrSC 2:40:2:25
...
{
float l9_0=varPackedTex.x;
sc_SoftwareWrapEarly(l9_0,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_1=l9_0;
float l9_2=varPackedTex.y;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_3=l9_2;
vec2 l9_4;
float l9_5;
...
{
l9_6=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_6=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_7=l9_1;
float l9_8=1.0;
sc_ClampUV(l9_7,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_6,l9_8);
float l9_9=l9_7;
float l9_10=l9_8;
bool l9_11;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
...
float l9_12=l9_3;
float l9_13=l9_10;
sc_ClampUV(l9_12,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_11,l9_13);
l9_5=l9_13;
...
#endif
vec2 l9_14=sc_TransformUV(l9_4,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_15=l9_14.x;
float l9_16=l9_5;
sc_SoftwareWrapLate(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_16);
float l9_17=l9_14.y;
float l9_18=l9_16;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_18);
}
#else
{
float l9_19=varPackedTex.x;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_20=l9_19;
float l9_21=varPackedTex.y;
sc_SoftwareWrapEarly(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_22=l9_21;
vec2 l9_23;
float l9_24;
#if (SC_USE_UV_MIN_MAX_baseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_25=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_25=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_26=l9_20;
float l9_27=1.0;
sc_ClampUV(l9_26,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_25,l9_27);
float l9_28=l9_26;
float l9_29=l9_27;
bool l9_30;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_30=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_30=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_31=l9_22;
float l9_32=l9_29;
sc_ClampUV(l9_31,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_30,l9_32);
l9_24=l9_32;
...
#endif
vec2 l9_33=sc_TransformUV(l9_23,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_34=l9_33.x;
float l9_35=l9_24;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_35);
float l9_36=l9_33.y;
float l9_37=l9_35;
sc_SoftwareWrapLate(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_37);
}
#endif
}
#else
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_38)>=(-0.050000001))
{
uvec3 l9_39=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_39.x,l9_39.y,l9_39.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_40=abs(l9_38);
vec3 l9_41=l9_38/vec3(dot(l9_40,vec3(1.0)));
float l9_42=clamp(-l9_41.z,0.0,1.0);
float l9_43=l9_41.x;
float l9_44;
if (l9_43>=0.0)
{
...
uvec2 l9_48=uvec2(packHalf2x16(vec2(l9_45,0.0)),packHalf2x16(vec2(l9_46+l9_47,0.0)));
normal_and_more=uvec4(l9_48.x,l9_48.y,normal_and_more.z,normal_and_more.w);
...
{
l9_49=uint(clamp(roughness,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_49|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
vec3 l9_8=max(l9_5.xyz,vec3(0.0));
vec4 l9_9;
#if (sc_ProjectiveShadowsCaster)
{
l9_9=vec4(l9_8,Port_Opacity_N023);
}
#else
{
l9_9=ngsCalculateLighting(l9_8,Port_Opacity_N023,l9_7,l9_2,l9_3,Port_Emissive_N023,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N023,Port_SpecularAO_N023);
}
#endif
vec4 l9_10=max(l9_9,vec4(0.0));
if (isProxyMode)
{
vec4 l9_11;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_15=clamp(l9_10.w*2.0,0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_10.xyz,vec3(l9_10.w)),0.0,1.0);
}
#else
{
float l9_17;
...
#if (sc_BlendMode_Multiply)
{
l9_18=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*l9_10.w;
}
#else
{
float l9_19;
...
{
l9_19=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*l9_10.w;
}
#else
{
float l9_20;
#if (sc_BlendMode_ColoredGlass)
{
l9_20=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_21;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_22=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_23;
...
{
l9_23=dot(l9_10.xyz,vec3(0.33333001))*l9_10.w;
}
#else
{
float l9_24;
...
{
vec3 l9_28=sc_GetFramebufferColor().xyz;
vec3 l9_29=mix(l9_28,definedBlend(l9_28,l9_10.xyz).xyz,vec3(l9_10.w));
...
{
float l9_32=l9_10.w;
l9_31=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_32)),l9_32);
}
#else
{
vec4 l9_33;
...
#endif
l9_33=vec4(l9_10.xyz*l9_35,l9_35);
}
#else
{
l9_33=l9_10;
