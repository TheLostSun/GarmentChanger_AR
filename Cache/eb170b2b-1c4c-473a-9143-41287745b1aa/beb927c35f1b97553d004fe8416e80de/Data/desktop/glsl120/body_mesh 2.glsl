...
//sampler sampler baseTextureSmpSC 2:16
...
//texture texture2D baseTexture 2:0:2:16
...
uniform float Port_Opacity_N023;
...
{
if (Port_Opacity_N023<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Opacity_N023<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_4=max(l9_1.xyz,vec3(0.0));
vec4 l9_5;
#if (sc_ProjectiveShadowsCaster)
{
l9_5=vec4(l9_4,Port_Opacity_N023);
}
#else
{
float l9_6=clamp(metallic,0.0,1.0);
float l9_7=clamp(roughness,0.0,1.0);
vec3 l9_8=ssSRGB_to_Linear(l9_4);
vec3 l9_9=normalize(l9_3);
vec3 l9_10=ssSRGB_to_Linear(Port_Emissive_N023);
vec3 l9_11;
#if (sc_SSAOEnabled)
{
l9_11=evaluateSSAO(varPos);
}
#else
{
l9_11=Port_AO_N023;
...
#endif
vec3 l9_12=vec3(l9_6);
vec3 l9_13=mix(vec3(0.039999999),l9_8*l9_6,l9_12);
vec3 l9_14=mix(l9_8*(1.0-l9_6),vec3(0.0),l9_12);
SurfaceProperties l9_15=SurfaceProperties(l9_14,Port_Opacity_N023,l9_9,varPos,l9_0,l9_6,l9_7,l9_10,l9_11,Port_SpecularAO_N023,vec3(1.0),l9_13);
vec4 l9_16=vec4(1.0);
vec3 l9_17;
vec3 l9_18;
vec3 l9_19;
...
{
LightingComponents l9_36=accumulateLight(LightingComponents(l9_24,l9_25,l9_30,l9_29,l9_27,l9_26),LightProperties(sc_DirectionalLights[l9_35].direction,sc_DirectionalLights[l9_35].color.xyz,sc_DirectionalLights[l9_35].color.w*l9_16[(l9_28<3) ? l9_28 : 3]),l9_15,l9_0);
...
{
vec3 l9_55=sc_PointLights[l9_53].position-varPos;
...
l9_46=l9_54+1;
LightingComponents l9_61=accumulateLight(LightingComponents(l9_40,l9_41,l9_45,l9_44,l9_43,l9_42),LightProperties(l9_56,sc_PointLights[l9_53].color.xyz,l9_60),l9_15,l9_0);
...
vec4 l9_66=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_65.x,l9_65.y),0.5);
...
{
vec2 l9_68=calcPanoramicTexCoordsFromDir(l9_9,sc_EnvmapRotation.y);
vec4 l9_69;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_70=calcSeamlessPanoramicUvsForSampling(l9_68,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_70=l9_68;
...
#endif
l9_69=sc_EnvmapSpecularSampleViewIndexBias(l9_70,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_71;
...
{
vec2 l9_72=calcSeamlessPanoramicUvsForSampling(l9_68,sc_EnvmapDiffuseSize.xy,0.0);
int l9_73;
...
#endif
l9_71=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_72,sc_EnvmapDiffuseLayout,l9_73,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_71=sc_EnvmapSpecularSampleViewIndexBias(l9_68,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_69=l9_71;
}
#endif
l9_67=(l9_69.xyz*(1.0/l9_69.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_74;
...
float l9_77=l9_75.y;
float l9_78=l9_75.z;
l9_74=(((((((sc_Sh[8]*0.42904299)*((l9_76*l9_76)-(l9_77*l9_77)))+((sc_Sh[6]*0.74312502)*(l9_78*l9_78)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_76*l9_77))+(sc_Sh[7]*(l9_76*l9_78)))+(sc_Sh[5]*(l9_77*l9_78)))*0.85808599))+((((sc_Sh[3]*l9_76)+(sc_Sh[1]*l9_77))+(sc_Sh[2]*l9_78))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_74=vec3(0.0);
...
{
l9_80=l9_67+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_81=l9_67;
l9_81.x=l9_67.x+(1e-06*sc_AmbientLights[0].color.x);
l9_80=l9_81;
}
#endif
l9_79=l9_80;
...
{
l9_83=l9_79+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_84=l9_79;
l9_84.x=l9_79.x+(1e-06*sc_AmbientLights[1].color.x);
l9_83=l9_84;
}
#endif
l9_82=l9_83;
...
{
l9_86=l9_82+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_87=l9_82;
l9_87.x=l9_82.x+(1e-06*sc_AmbientLights[2].color.x);
l9_86=l9_87;
}
#endif
l9_85=l9_86;
...
{
vec3 l9_89;
l9_89=sc_LightEstimationData.ambientLight;
vec3 l9_90;
int l9_91=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_91<sc_LightEstimationSGCount)
{
float l9_92=dot(sc_LightEstimationData.sg[l9_91].axis,l9_9);
float l9_93=exp(-sc_LightEstimationData.sg[l9_91].sharpness);
float l9_94=l9_93*l9_93;
float l9_95=1.0/sc_LightEstimationData.sg[l9_91].sharpness;
float l9_96=(1.0+(2.0*l9_94))-l9_95;
float l9_97=sqrt(1.0-l9_96);
float l9_98=0.36000001*l9_92;
float l9_99=(1.0/(4.0*0.36000001))*l9_97;
float l9_100=l9_98+l9_99;
float l9_101;
if (step(abs(l9_98),l9_99)>0.5)
{
l9_101=(l9_100*l9_100)/l9_97;
}
else
{
l9_101=clamp(l9_92,0.0,1.0);
}
l9_90=l9_89+((((sc_LightEstimationData.sg[l9_91].color/vec3(sc_LightEstimationData.sg[l9_91].sharpness))*6.2831855)*((l9_96*l9_101)+(((l9_93-l9_94)*l9_95)-l9_94)))/vec3(3.1415927));
l9_89=l9_90;
l9_91++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_103=clamp(pow(l9_7,0.66666669),0.0,1.0)*5.0;
vec2 l9_104=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_9,reflect(-l9_0,l9_9),l9_7),sc_EnvmapRotation.y);
vec4 l9_105;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_106=floor(l9_103);
float l9_107=ceil(l9_103);
l9_105=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_104,sc_EnvmapSpecularSize.xy,l9_106),sc_EnvmapSpecularGetStereoViewIndex(),l9_106),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_104,sc_EnvmapSpecularSize.xy,l9_107),sc_EnvmapSpecularGetStereoViewIndex(),l9_107),vec4(l9_103-l9_106));
}
#else
{
l9_105=sc_EnvmapSpecularSampleViewIndexLevel(l9_104,sc_EnvmapSpecularGetStereoViewIndex(),l9_103);
}
#endif
l9_102=vec3(0.0)+((((l9_105.xyz*(1.0/l9_105.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_15,abs(dot(l9_9,l9_0))));
}
#else
{
l9_102=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_109=clamp(l9_7*l9_7,0.0099999998,1.0);
vec3 l9_110;
l9_110=sc_LightEstimationData.ambientLight*l9_13;
int l9_111=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_111<sc_LightEstimationSGCount)
{
float l9_112=l9_109*l9_109;
vec3 l9_113=reflect(-l9_0,l9_9);
float l9_114=dot(l9_9,l9_0);
float l9_115=(2.0/l9_112)/(4.0*max(l9_114,9.9999997e-05));
float l9_116=length((l9_113*l9_115)+(sc_LightEstimationData.sg[l9_111].axis*sc_LightEstimationData.sg[l9_111].sharpness));
float l9_117=clamp(dot(l9_9,l9_113),0.0,1.0);
float l9_118=clamp(l9_114,0.0,1.0);
float l9_119=1.0-l9_112;
l9_110+=((((((((vec3(1.0/(3.1415927*l9_112))*exp((l9_116-l9_115)-sc_LightEstimationData.sg[l9_111].sharpness))*sc_LightEstimationData.sg[l9_111].color)*6.2831855)*(1.0-exp((-2.0)*l9_116)))/vec3(l9_116))*((1.0/(l9_117+sqrt(l9_112+((l9_119*l9_117)*l9_117))))*(1.0/(l9_118+sqrt(l9_112+((l9_119*l9_118)*l9_118))))))*(l9_13+((vec3(1.0)-l9_13)*pow(1.0-clamp(dot(l9_113,normalize(l9_113+l9_0)),0.0,1.0),5.0))))*l9_117);
l9_111++;
continue;
}
else
...
l9_123=vec3(0.0);
l9_122=vec3(0.0);
l9_121=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_14,vec3(Port_Opacity_N023));
l9_120=1.0;
}
#else
{
...
#endif
vec3 l9_125=l9_122*l9_11;
vec3 l9_126=l9_123+l9_125;
vec3 l9_127=l9_14*l9_126;
vec3 l9_128=l9_108*Port_SpecularAO_N023;
vec3 l9_129=l9_62+l9_128;
vec3 l9_130;
if (l9_124)
{
l9_130=l9_127*srgbToLinear(l9_120);
}
else
{
l9_130=l9_127;
}
vec3 l9_131=l9_130+l9_129;
vec3 l9_132=(l9_131+l9_10)+l9_121;
float l9_133=l9_132.x;
vec4 l9_134=vec4(l9_133,l9_132.yz,l9_120);
vec4 l9_135;
#if (sc_IsEditor)
{
vec4 l9_136=l9_134;
l9_136.x=l9_133+((l9_11.x*Port_SpecularAO_N023.x)*9.9999997e-06);
l9_135=l9_136;
}
#else
{
...
{
vec3 l9_138=l9_135.xyz*1.8;
vec3 l9_139=(l9_135.xyz*(l9_138+vec3(1.4)))/((l9_135.xyz*(l9_138+vec3(0.5)))+vec3(1.5));
l9_137=vec4(l9_139.x,l9_139.y,l9_139.z,l9_135.w);
}
#else
{
l9_137=l9_135;
...
#endif
vec3 l9_140=vec3(linearToSrgb(l9_137.x),linearToSrgb(l9_137.y),linearToSrgb(l9_137.z));
l9_5=vec4(l9_140.x,l9_140.y,l9_140.z,l9_137.w);
}
#endif
vec4 l9_141=max(l9_5,vec4(0.0));
vec4 l9_142;
#if (sc_ProjectiveShadowsCaster)
{
float l9_143;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_144=clamp(l9_141.w*2.0,0.0,1.0);
}
#else
{
float l9_145;
...
{
l9_145=clamp(dot(l9_141.xyz,vec3(l9_141.w)),0.0,1.0);
}
#else
{
float l9_146;
...
#if (sc_BlendMode_Multiply)
{
l9_147=(1.0-dot(l9_141.xyz,vec3(0.33333001)))*l9_141.w;
}
#else
{
float l9_148;
...
{
l9_148=(1.0-clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0))*l9_141.w;
}
#else
{
float l9_149;
#if (sc_BlendMode_ColoredGlass)
{
l9_149=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0)*l9_141.w;
}
#else
{
float l9_150;
#if (sc_BlendMode_Add)
{
l9_150=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_151;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_151=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0)*l9_141.w;
}
#else
{
float l9_152;
...
{
l9_152=dot(l9_141.xyz,vec3(0.33333001))*l9_141.w;
}
#else
{
float l9_153;
#if (sc_BlendMode_Min)
{
l9_153=1.0-clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_154;
#if (sc_BlendMode_Max)
{
l9_154=clamp(dot(l9_141.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_154=1.0;
...
#endif
l9_142=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_141.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_143);
}
#else
{
vec4 l9_155;
...
{
vec3 l9_157=sc_GetFramebufferColor().xyz;
vec3 l9_158=mix(l9_157,definedBlend(l9_157,l9_141.xyz).xyz,vec3(l9_141.w));
vec4 l9_159=vec4(l9_158.x,l9_158.y,l9_158.z,vec4(0.0).w);
l9_159.w=1.0;
l9_156=l9_159;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_161=l9_141.w;
l9_160=vec4(mix(vec3(1.0),l9_141.xyz,vec3(l9_161)),l9_161);
}
#else
{
vec4 l9_162;
...
#endif
l9_162=vec4(l9_141.xyz*l9_164,l9_164);
}
#else
{
l9_162=l9_141;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_172=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
