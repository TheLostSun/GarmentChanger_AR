...
var lowerMaleBrands=["A","B","Levis"];
var lowerFemaleBrands=["Pepe","Spykar"];
...
function moveRight(){
    ...
    if(meshVisual){
       if(script.isMale){
            ...
            script.BrandLower.text=upperMaleBrands[currentMeshIndex];        
        }
        else{
            ...
            script.BrandLower.text=upperFemaleBrands[currentMeshIndex];        
        }
